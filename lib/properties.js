...
const PROPERTIES = {
  // ARCHIVED — off the public site since 2026-09-05, and its Airbnb listing was deactivated
  // (not deleted) as of 2026-09-25. Kept so the endpoints keep resolving if it's ever
  // reactivated; nothing currently fetches them. Don't wire anything new to it, and only
  // remove it if the Airbnb listing is deleted outright. See README "Crew House removed".
