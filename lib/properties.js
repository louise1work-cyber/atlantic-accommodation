 ...
 * (outbound feed, direct bookings -> Airbnb) and api/availability/[property].js
 * (inbound feed, Airbnb -> this site) both have to agree on exactly the same
 * slugs and the same "property" values, or one of them silently 404s.
 *
...
module.exports = { PROPERTIES, airbnbEnvVar, resolveProperty };
